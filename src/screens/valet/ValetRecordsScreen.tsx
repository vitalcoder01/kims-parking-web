          ...
          {STAGE_FILTERS.map(sf => {
            ...
            return (
              <PressableScale
                ...
                style={{flexShrink: 0, borderRadius: 99, border: `1px solid ${on ? colors.primary : colors.border}`, padding: '7px 14px', backgroundColor: on ? colors.primary : colors.surface}}
              >
                <span style={{fontSize: 12, fontWeight: 700, whiteSpace: 'nowrap', color: on ? colors.textOnPrimary : colors.textSecondary}}>
                  {sf.label}
                </span>
              </PressableScale>
            );
