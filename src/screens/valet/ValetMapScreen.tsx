...
// Direct port of the mobile app's ValetMapScreen — the live multi-driver GPS
// map. Used to also carry the slot occupancy grid as a "Parking Layout"
// sub-tab; that moved into the Jobs page (alongside Visitors/Staff, as
// another kind of record) so this screen is GPS-only now.
