...
export const RELEASE_NOTES =
  'Admin Dashboard: simplified the top bar — removed the title, "vs Previous Period" pill, Live badge, notification bell and avatar, keeping just search, period, refresh and theme toggle.';
