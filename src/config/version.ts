...
export const APP_VERSION_NAME = '1.10.3';
export const RELEASE_NOTES =
  'Admin mobile: removed the top title bar ("Operations", "Staff", "Live Map", etc.) from every tab — Dashboard, Staff, Attendance, Map, Analytics and Settings all now start right at their content.';
