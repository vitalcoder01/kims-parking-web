...
export const APP_VERSION_NAME = '1.8.21';
export const RELEASE_NOTES =
  'Fixed /admin showing your existing session instead of the admin sign-in when you already had any account logged in on this browser.';
