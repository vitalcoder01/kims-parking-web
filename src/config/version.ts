...
export const APP_VERSION_NAME = '1.10.9';
export const RELEASE_NOTES =
  "Lot valet's Confirm Parked now has the same 'Auto-assign nearest free slot' shortcut and available-slots list the driver's own screen used to have.";
